...
(() => {
  ...
  const CONFIG = {
    ...
    galleryImages: [
      ...
      { src: 'aya3.jpeg', cap: 'دفء لا يوصف' },
      { src: 'aya4.jpeg', cap: 'أثر يبقى في القلب' },
      { src: 'aya5.jpeg', cap: 'بريق عينيكِ' },
      { src: 'aya6.jpeg', cap: 'أجمل الذكريات' }
    ],
    timeline: [
      { year: '2016', icon: '😁', title: 'بداية جديدة', desc: 'بداية فصلٍ مليء بالأحلام.' },
      { year: '2019', icon: '❤️', title: 'آفاق جديدة', desc: 'استكشاف العالم وذكريات لا تُنسى.' },
      { year: '2024', icon: '😊', title: 'إنجاز كبير', desc: 'محطة تستحق الفخر.' },
      { year: '2025', icon: '💜', title: 'أقوى من أي وقت', desc: 'محاطة بالحب وأصدقاء أوفياء.' },
    ...
    memoryBook: [
      { img: 'ANAWYAYA1.jpeg', title: 'ضحكات لا تنتهي', date: '2026', text: 'فرحٌ لا يصنعه إلا الأصدقاء.' },
      { img: 'anawyaya2.jpeg', title: 'بحتفل النهارده بأجمل بنت ', date: '2026', text: 'وها نحن هنا، نحتفل بكِ.' }
    ],
    reasons: [
